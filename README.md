...
![Tests](https://img.shields.io/badge/tests-unit%20tested-success)
...
- State-driven UI updates via centralized stores
- Form handling, validation, and authentication flows
- Data visualization and dashboard-style UX
...
| Framework        | Vue 3                                   |
| Language         | TypeScript                              |
| State Management | Modular store pattern                   |
| Routing          | Vue Router                              |
| Charts           | Custom chart components (Pie / Summary) |
| Styling          | CSS                                     |
